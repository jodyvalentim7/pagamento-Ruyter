...
function showToast(name){
  ...
  t.innerHTML = `
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M20 6L9 17l-5-5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
    <div class="toast-body">
      <div class="toast-name">${name.toUpperCase()}</div>
      <div class="toast-sub">REALIZOU SUA COMPRA</div>
    </div>`;
  toastWrap.appendChild(t);
  // auto-remove after 1.7s
  setTimeout(()=>{
